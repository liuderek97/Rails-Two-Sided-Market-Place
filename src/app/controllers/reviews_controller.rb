class ReviewsController < ApplicationController
  ...
  def new
    @review = Review.new
    @review.reviewed_id = params[:profile_id]
    @review.reviewer_id = current_profile.id
  end
  ...
  private
    ...
    def review_params
      params.require(:review).permit(:star_rating, :title, :content, :reviewed_id, :reviewer_id)
    end
end
